...
def longestZero(a : List[int]) -> Tuple[int, int]:
    ...
    while (d_5_idx_) < ((len((a))) - (1)):
        ...
        Invariant(Forall(int, lambda d_8_i_:
            (Implies(((0) <= (d_8_i_)) and ((d_8_i_) <= (d_5_idx_)),
        ...
        Invariant(Forall(int, lambda d_10_i_:
            (Implies(((0) <= (d_10_i_)) and ((d_10_i_) <= (d_5_idx_)),
    ...
    while (d_5_idx_) < (len((a))):
        ...
        Invariant(Forall(int, lambda d_6_i_:
            (Implies(((0) <= (d_6_i_)) and ((d_6_i_) < (len(a))), 0 <= (d_4_b_)[d_6_i_] and (((d_4_b_)[d_6_i_]) <= (d_6_i_ + 1))),
                [[(d_4_b_)[d_6_i_]]])))
        ...
        Invariant(Forall(int, lambda d_11_i_:
            (Implies(((0) <= (d_11_i_)) and ((d_11_i_) < (d_5_idx_)), ((d_4_b_)[d_11_i_]) <= (sz)),
                [[(d_4_b_)[d_11_i_]]])))
        Invariant(Forall(int, lambda d_8_i_:
            (Implies(((0) <= (d_8_i_)) and ((d_8_i_) <= (len(a) - 1)),
                Forall(int, lambda d_9_j_:
                    (Implies((((d_8_i_) - ((d_4_b_)[d_8_i_])) < (d_9_j_)) and ((d_9_j_) <= (d_8_i_)), ((a)[d_9_j_]) == (0)),
                        [[(a)[d_9_j_]]]))),
                [[((d_4_b_)[d_8_i_])]])))
        Invariant(Forall(int, lambda d_12_i_:
            (Implies(((pos - 1) < (d_12_i_)) and ((d_12_i_) <= ((pos) + (sz)) - 1),
                ((a)[d_12_i_]) == (0)),
                [[(a)[d_12_i_]]])))
        Invariant(Forall(int, lambda d_10_i_:
            (Implies(((0) <= (d_10_i_)) and ((d_10_i_) < (len(a))),
                Implies((0) <= ((d_10_i_) - ((d_4_b_)[d_10_i_])),
                    (d_10_i_) - ((d_4_b_)[d_10_i_]) >= 0 and (d_10_i_) - ((d_4_b_)[d_10_i_]) < len(a) and ((a)[(d_10_i_) - ((d_4_b_)[d_10_i_])]) != (0))),
                [[(d_4_b_)[d_10_i_]]])))

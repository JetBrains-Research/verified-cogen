...
def RemoveDuplicates(a : List[int]) -> List[int]:
    ...
    while d_5_i_ < len(a):
        ...
        Invariant(Forall(int, lambda d_6_x_:
            (Implies(d_6_x_ >= 0 and d_6_x_ < len(d_4_res_), (InArray(a, d_4_res_[d_6_x_]))), [[d_4_res_[d_6_x_]]])))
        ...
        if (NotInArray(d_4_res_, (a)[d_5_i_])):
            ...
            Assert(Forall(int, lambda d_6_x_:
                (Implies(d_6_x_ >= 0 and d_6_x_ < len(d_4_res_), (InArray(a, d_4_res_[d_6_x_]))), [[d_4_res_prev[d_6_x_]]])))

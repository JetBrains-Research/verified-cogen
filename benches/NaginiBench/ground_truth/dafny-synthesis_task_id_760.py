...
def HasOnlyOneDistinctElement(a : List[int]) -> bool:
    ...
    while d_5_i_ < len(a):
        ...
        Invariant(((1) <= (d_5_i_)) and ((d_5_i_) <= (len((a)))))
        Invariant(Implies(result, Forall(int, lambda d_6_k_:
            Implies(((0) <= (d_6_k_)) and ((d_6_k_) < (d_5_i_)), ((a)[d_6_k_]) == (d_4_firstElement_)))))
        Invariant(Implies(not(result), Exists(int, lambda d_2_i_:
            Exists(int, lambda d_3_j_:
                ((((0) <= (d_2_i_)) and ((d_2_i_) < d_5_i_)) and (((0) <= (d_3_j_)) and ((d_3_j_) < d_5_i_))) and (((a)[d_2_i_]) != ((a)[d_3_j_]))))))
